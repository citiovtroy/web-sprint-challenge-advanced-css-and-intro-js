...
making sites accessible to those with disabilities

2. Talk about 3 different things you can do to ensure your website is accessible. 

use headings to structure data
proper text alt on images
making all content keyboard accessible
...
creating small blocks of code to use for particular reason
